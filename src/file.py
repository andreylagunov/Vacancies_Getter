...
class JSONHandler(FileHandler):
    ...
    def __init__(self, file_name: str = "saved_vacancies.json") -> None:
        """
        В экземпляре есть атрибут - имя файла,
        которое может быть назначено при создании экземпляра.
        """
    ...
    def get_dict_of_attributes(self) -> dict[str, str]:
        ...
        return {
            ...
            "relative_file_path": self.__relative_file_path
        }
    ...
    def add_data_to_file(self, vacancy: Vacancy) -> None:
        ...
        # Дозаписываем новую вакансию.
        # self.__append_to_file(vacancy)
    ...
    def delete_data_from_file(self, vacancy: Vacancy) -> None:
        ...
        deleted_vacancy_list: list = [vac_dict for vac_dict in vacancy_list if vac_dict["speciality"] != vacancy.speciality]
...
if __name__ == "__main__":
    ...
    # # {"people": [{"name": "Ivan", "phone": "777", "country": "Russia"}, {"name": "Irina", "phone": "963", "country": "Russia"}]}
    #
